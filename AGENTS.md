# Isa-Mini Agent Instructions

## Rules

Never delete golden YAML in test cases. You may edit the YAML manually to update it if you are absolutely certain.

This is a shared working tree. Commit only explicit paths you intentionally
touched. If the user asks you to commit a file that already contains unrelated
changes from other agents, call that out and make the commit message describe
the included work accurately.
